...
namespace CppCLRWinformsProjekt {
	...
	using namespace System::Net;//äëÿ ñîçäàíèÿ âåá êëèåíòà
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Ââåäèòå ñóììó â ðóáëÿõ";
			// 
			// label2
			// 
			...
			this->label2->Text = L"Âûáåðèòå âàëþòó:";
			// 
			// comboBox1
			// 
			...
			this->button1->Text = L"Óçíàòü êóðñ";
